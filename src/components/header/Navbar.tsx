  ...
  return (
    <nav className="bg-white border-gray-200 px-4 md:px-8 py-3">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl h-11">
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 bg-white z-20" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:mt-0 gap-x-7">
                    <li>
                        <a href="/" className="block py-2 pr-4 pl-3 text-gray-700 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0" aria-current="page">Inicio</a>
                    </li>
                    <li>
                        <a href="/catalogo" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Catálogo</a>
                    </li>
                    <li>
