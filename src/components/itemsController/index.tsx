...
export default function ItemsController ({articlesAmount, setShowFilterMenu}: ItemsControllerProps):JSX.Element {
  return (
    <div className="w-full flex justify-between items-center px-4 md:px-8 max-w-screen-2xl mx-auto mt-5">
      <h5 className="font-semibold text-lg hidden md:inline-block">{articlesAmount} articulos</h5>
      <div className="flex items-center justify-between text-xs w-full md:w-fit">
        <div className="flex items-center md:w-fit">
          ...
          <select name="orderBy" id="orderBy" className="mr-4 bg-transparent focus:outline-none">
